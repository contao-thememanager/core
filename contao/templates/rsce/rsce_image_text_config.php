...
return [
    ...
    'fields' => [
        ...
        'fullsize' => [
            'label' => [
                'de' => ['Großansicht/Neues Fenster', 'Großansicht des Bildes in einer Lightbox bzw. in einem neuen Browserfenster öffnen.'],
                'en' => ['Full-size view/new window', 'Open the image in a lightbox or in a new browser window.'],
            ],
            'inputType' => 'checkbox',
